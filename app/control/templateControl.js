 ...
 * @LastEditTime: 2023-10-21 19:53:58
...
import userInfo from '../../src/views/userInfo.hbs'
import slider from '../../src/views/slider.hbs'

const TEMP_MAP = {
  user, modal, write, article, message, articles, columns, comment, toolbar, userInfo, slider
}
